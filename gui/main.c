...
constexpr int APP_WIDTH = 800;
constexpr int APP_HEIGHT = 600;
...
int main(int argc, char **argv)
{
	...
	app_data_set(argv);
	GtkApplication *app = gtk_application_new("com.github.AndrewMaksimchuk.note", G_APPLICATION_DEFAULT_FLAGS);
